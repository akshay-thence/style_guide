...
_\*Thence Style Guide works on iOS, Android, Web, and Windows._
...
## Building 
  keytool -genkey -v -keystore ~/upload-keystore.jks -keyalg RSA -keysize 2048 -validity 100000 -alias upload
